...
BIP32_TEST_5_VECTORS_INVALID_HDKEYS = (
    # (bip32Test5_invalid_extended_key_b58str, bip32Test5_error_description, expected_exception)
    (
...
class Bip32Test(TestCase):
    ...
    def test_HDKey_from_base58(self):
        for invalid, reason, expected in BIP32_TEST_5_VECTORS_INVALID_HDKEYS:
            if expected is not None:
                with self.assertRaises(expected):
                     HDKey.from_base58(invalid)
